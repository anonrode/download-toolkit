...
class LiveProgress:
    ...
    def __init__(self, filename):
        ...
        self._done    = False
        with _PRINT_LOCK:
            # Print filename line, then blank progress line ready for \r
            sys.stdout.write(f'  {BCYAN}\u2193{RESET}  {WHITE}{filename}{RESET}\n')
            sys.stdout.write(f'     ')
            sys.stdout.flush()
    ...
    def update(self, pct, speed_mbs=None, eta=None):
        ...
        with _PRINT_LOCK:
            ...
            # \r returns to col 0 of current line, overwriting the blank line we left
    ...
    def fail(self):
        self._done = True
        with _PRINT_LOCK:
            sys.stdout.write(f'\r     {RED}failed{RESET}              \n')
            sys.stdout.flush()
