...
def main():
    ...
    while True:
        ...
        if lower in ('exit', 'quit', 'q'):
            ...
            print("  COMMANDS")
            print(f"{'='*50}")
            print("  anime <title>          - Search and download anime (AllAnime/sub)")
            print("  search <title>         - Find a show/movie across all search sites")
            print("  fsearch <title> [hint] - Fast search (korean|chinese|nollywood|etc)")
            print("  <url>                  - Paste direct URL to start downloading")
            print("  clip                   - Download link copied to clipboard")
            print("  watch                  - Start clipboard watcher mode")
            print("  resume                 - Select a paused download to resume")
            print("  resume clear [text]    - Clear resume list (all, or entries matching text)")
            print("  cache clear            - Clear saved search results")
            print("  status                 - Show current download speed & status")
            print("  queue add <url>        - Add a link to download queue")
            print("  queue list/clear/run   - Manage download queue")
            print("  qad/quad <url> ...     - Quick-add one or more links to queue")
            print("  qas                    - Start (run) the download queue")
            print("  settings               - Open interactive settings menu")
            print("  update                 - Update toolkit from GitHub")
            print("  version                - Show current version & update status")
            print("  updateyt               - Update yt-dlp only")
            print("  fminstall              - Install ffmpeg (needed for some YouTube downloads)")

            print("  doctor                 - Check Termux dependencies")
            print("  cleanup                - Delete temporary/stale files")
            print("  history                - Show past download history")
            print("  exit                   - Quit app")
            print(f"{'='*50}")
            print("  Ctrl+P = pause/resume (Termux)   Ctrl+C = stop and save for resume")
            print(f"{'='*50}")
